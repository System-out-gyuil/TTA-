...
def generate_final_json(label_file, refine_file):
    ...
    # 최종 데이터를 JSON 파일로 저장
    with open('15-2_output_data.json', 'w', encoding='utf-8') as f_final:
        json.dump(final_data, f_final, indent=4, ensure_ascii=False)

    print("Final JSON file created successfully.")

# 호출하여 파일을 처리
label_file_path = 'C:\\Users\\admin\\Desktop\\syntax_check_converter\\2024-nia15-2-label-new.json'
refine_file_path = 'C:\\Users\\admin\\Desktop\\syntax_check_converter\\2024-nia15-2-refine-new2.json'
