...
# 원천데이터(이미지파일) 경로
dir_path = f"C:\\Users\\admin\\Desktop\\syntax_check_converter - 복사본\\문단1"
img_path_list = []
...
for path in tqdm(img_path_list):
    ...
    for make in makes:
        if make.get('raw_data_info').get('raw_data_name') == img_name:
            os.rename(path, f'C:\\Users\\admin\\Desktop\\syntax_check_converter - 복사본\\문단1\\{make.get('source_data_info').get('source_data_name')}.png')