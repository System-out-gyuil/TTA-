...
def process_label_data(label_data):
    ...
    for item in label_data:
        ...
        # 질문과 답변이 비어 있을 때만 text_description으로 채움
        if not text_qa:
...
# 호출하여 파일을 처리
label_file_path = 'C:\\Users\\admin\\Desktop\\syntax_check_converter - 복사본\\2024-nia15-1-label-new.json'
refine_file_path = 'C:\\Users\\admin\\Desktop\\syntax_check_converter - 복사본\\2024-nia15-1-refine-new2.json'
